sap.ui.define(
	...
	function(UIComponent){
		return UIComponent.extend("raov.app.Component",{
			metadata: {
				manifest: "json"
			},
			init: function(){
			...
			// 		viewName: "raov.app.view.View1",
			// 		type: "XML"
			// 	});
			
			// 	var oView2 = new sap.ui.view("idView2",{
			// 		viewName: "raov.app.view.View2",
			// 		type: "XML"
			// 	});
			// 	var oEmpty = new sap.ui.view("idEmpty",{
			// 		viewName: "raov.app.view.Empty",
			// 		type: "XML"
			// 	});
